...
//ejecutivos. Si hay tales solicitudes, hágalas primero a menos que tenga una solicitud de 
//emergencia de otro departamento. Una vez que hayas terminado con la solicitud de cumplimiento, 
//riegue la planta de mi escritorio después de apagar la computadora. Ah, espera, debería haber 
//mencionado un par de cosas: debes iniciar sesión con usuario de administrador para ver los 
//informes de marketing, y tendrás que enviarme un correo electrónico de actualización justo 
//después de que termines de manejar las solicitudes. Bueno, gracias de nuevo. 
