...
Algoritmo Clase11_Desafio_Ej3
		...
		Escribir "Bienvenido a la máquina de reciclaje de botellas"
		...
		Si user = "Albus_D" Entonces
			...
			Sino
				Para intentos = 2 Hasta 3
					Escribir  "Contraseña incorrecta, intente nuevamente, intento num: " intentos
					leer pass
				FinPara
				Escribir "Superaste el número de intentos, se cerrará el programa"
			FinSi
